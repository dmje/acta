<div class="featured-item <?php echo $arr['item_class']; ?>" <?php if(isset($arr['item_id'])){echo 'id="' . $arr['item_id'] . '"';} ?>>
	...
	<div class="featured-item__content">
		<h3 class="featured-item__title"><a href="<?php echo $arr['item_link']; ?>"><?php if(isset($arr['item_title'])){echo $arr['item_title'];} ?></a></h3>
		<?php if(isset($arr['item_description'])){echo $arr['item_description']; }?>
		<?php if(isset($arr['item_link']) && null!==$arr['item_link']){?>
			<p>
				<a href="<?php echo $arr['item_link']; ?>" class="featured-item__link">
					<?php echo $arr['item_link_text']; ?>
				</a>
			</p>			
		<?php }?>
	</div>
