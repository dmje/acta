...
JsDatePick.prototype.executeOnSelectedDelegateIfExists = function (element) {
    if (typeof (this.onSelectedDelegate) == "function") {
        this.onSelectedDelegate(element)
    }
...
JsDatePick.prototype.populateMainBox = function (h) {
    ...
    while (j.getMonth() == n) {
        ...
        g.onmouseup = function () {
            ...
            d.executeOnSelectedDelegateIfExists(this)
        };
